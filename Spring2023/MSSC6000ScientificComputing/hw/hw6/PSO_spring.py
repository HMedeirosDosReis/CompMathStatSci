...
# 2 - Particle Swarm Optmization for Spring function  
...
class ContinuousFunction:
    ...
    """
    Check if a point meets all the constraints 
    """
...
class Particle:
    ...
    def __init__(self, initial_position, dimension, max_speed, my_function):
        ...
        my_function = the function defining the space where the particle is in
        """
    ...
    def advance_position(self, global_best, alpha, beta, gamma):
        ...
        # Instead of moving without checking if the next position is valid
        ...
        if (self.func.in_bounds(next_position) 
            ...
            # If we get here, we are ok, so move there
    ...
    def set_global_best(self):
        ...
        for particle in self.particles:
            ...
            if (
                ...
                # Print the result everytime we improve our solution
...
# define the problem we're solving wdL
eval_function = lambda w,d,L: (2+L)*d*w**2
# Define the bounds for our function
